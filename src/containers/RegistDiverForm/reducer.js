...
export default function reducer (state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case FILL_EXTRAUSERINFO_SUCCESS:
      return { ...state, showLoad: !state.showLoad, userInfo: payload, showApplyPro: true, fillExtraUserInfoSuccess: true, certMetas: action.certMetas }
    case FILL_EXTRAUSERINFO_SUCCESS_NOAPPLYPRO:
      return {
        ...state,
