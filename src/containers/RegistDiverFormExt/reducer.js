...
const initialState = {
  ...
  finalFinish: false,
  userEmail: '',
  fillExtraUserInfoSuccess: false
}
...
export default function reducer (state = initialState, action) {
  ...
  switch (action.type) {
    case CREATE_USER_SUCCESS:
      return { ...state, showLoad: !state.showLoad, userInfo: payload.userInfo, userEmail: payload.userInfo.email, deepbluId: payload.userInfo.deepbluId, accessToken: payload.accessToken }
    ...
    case FILL_EXTRAUSERINFO_SUCCESS:
      return {
        ...
        userInfo: payload,
        showApplyPro: true,
        fillExtraUserInfoSuccess: true,
        certMetas: action.certMetas }
    case NOT_PRO_NOAPPLY_AMB:
      return {
        ...state,
        showLoad: !state.showLoad,
        plainRegularFinal: true
      }
    ...
    case EXISTING_RESELLETR_FINAL:
      return { ...state, showLoad: !state.showLoad, resellerFinish: true, businessData: payload}
    ...
    case FILL_PROINFO_SUCCESS:
      return { ...state, showLoad: !state.showLoad, data: payload, profinish: true }
    case CONTINUE_AMB_PROCESS:
      return { ...state, showLoad: !state.showLoad, data: payload, ambContinue: true }
    case FILL_AMBINFO_SUCCESS:
      return { ...state, showLoad: !state.showLoad, data: payload, ambfinish: true }
    case RENDER_PRO_FINALPAGE:
      return { ...state, profinish: true }
