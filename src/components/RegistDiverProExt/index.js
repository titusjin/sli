...
class RegistDiverPro extends React.Component {
  constructor (props) {
    ...
    this.setVerificationCodeForAmb = this.setVerificationCodeForAmb.bind(this)
    ...
    this.renderChooseRenderAmbSpecifc = this.renderChooseRenderAmbSpecifc.bind(this)
  }
...
//		let needed = [ 'certOrg', 'certLevel', 'certNum', 'ambOption' ];
    let needed = [ 'certOrg', 'certLevel', 'ambOption' ]
    let result = ''
  ...
  setVerificationCodeForAmb (e) {
    let result = e.target.value
    let preData = this.state.data

    this.setState({
      data: {...preData, verifyCode: result}
    })
  }
  ...
  saveAmbData () {
    ...
    if (result) {
      ...
      swalTrigger.triggerGeneralAlert('fail', 'Please Confirm MAP aggrement, thanks! :')
    } else {
  ...
  renderChooseRenderAmbSpecifc () {
    if ((this.props.showApplyPro && !this.props.proyes && this.state.data.userInfo.userDiveType == 'Pro')) {
      return (
        <div className={cx('basicInfoContainer')}>
          <FormGroup controlId='ambassadorOption'>
            <Col sm={3}>
              <label className={cx('ControlLabel')}>
                                Want to be COSMIQ+ Sales Ambassador&#1645;
                            </label>
            </Col>
  ...
  renderAmbSpecific () {
        // ambContinue in props for set pro cert first
        // ambContinue in state for already pro user not uplaoding another certs
        ...
        <div className={cx('basicInfoContainer')}>
          ...
          <FormGroup>
            ...
            <Col sm={4} className={cx('inputFieldDiv')}>
              <FormControl
                type='text'
                placeholder='Phone number wihtout prefix' onChange={this.setPhone} />
            </Col>
          </FormGroup>
          ...
          <FormGroup>
            <Col sm={3}>
              <label className={cx('ControlLabel')}>
                                Estimated Number of Dive Students Taught per Month
                            </label>
            </Col>
            <Col sm={7} className={cx('inputFieldDiv')}>
              <Select
          ...
          <FormGroup>
            ...
            <Col sm={7} className={cx('inputFieldDiv')}>
              <FormControl
                type='password'
                onChange={this.setVerificationCodeForAmb} />
            </Col>
          </FormGroup>
  ...
  renderProSpecific () {
    if (this.props.showApplyPro && this.props.proyes) {
      return (
        <div className={cx('basicInfoContainer')}>
          <FormGroup>
            <Col sm={3}>
          ...
          <FormGroup controlId='ambassadorOption'>
            ...
            <Col sm={7} className={cx('inputFieldDiv')}>
              ...
              <Checkbox className={cx('checkboxStyle')}
                ...
                value='n'
                style={{
                  display: this.props.profinish ? 'none' : ''
                }}
                disabled={this.props.ambContinue}>
                <span>Maybe Later</span>
              </Checkbox>
